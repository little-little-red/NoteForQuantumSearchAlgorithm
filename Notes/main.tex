...
As shown in the Figure \ref{fig:long}, $I_{O}$ gives us a rotation of angle $-\phi$ about axis $\ket{\alpha}\to(0,0,1)^{T}$ and $I_{W}$ gives us a rotation of angle $\phi$ about axis $\ket{\psi}\to(\sin\theta,0,\cos\theta)^{T}$, their produt $Q=I_{W}I_{O}$ gives us a rotation of angle $\omega=4\arcsin(\sin\frac{\phi}{2}\sin\frac{\theta}{2})$ about axis $\ket{q}\to k(\cos\frac{\phi}{2},\sin\frac{\phi}{2},\cos\frac{\phi}{2}\tan\frac{\theta}{2})^{T}$, where $k$ is the normalization factor.
